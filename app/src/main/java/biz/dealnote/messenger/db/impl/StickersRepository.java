 ...
 * phoenix
 */
class StickersRepository extends AbsRepository implements IStickersRepository {

    StickersRepository(@NonNull AppRepositories base) {
        super(base);
    }
    ...
    public Completable store(int accountId, List<VKApiStickerSet.Product> sets) {
        return Completable.create(e -> {
            ...
            Exestime.log("StickersRepository.store", start, "count: " + safeCountOf(sets));
        });
    }
    ...
    public Single<List<StickerSet>> getPurchasedAndActive(int accountId) {
        return Single.create(e -> {
            ...
            Exestime.log("StickersRepository.get", start, "count: " + stickers.size());
        });
    }
