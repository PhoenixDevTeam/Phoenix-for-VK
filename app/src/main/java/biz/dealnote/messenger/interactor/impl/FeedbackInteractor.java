...
import biz.dealnote.messenger.interactor.mappers.FeedbackEntity2Model;
...
import static biz.dealnote.messenger.interactor.mappers.Entity2Model.fillCommentOwnerIds;
...
public class FeedbackInteractor implements IFeedbackInteractor {
    ...
    public FeedbackInteractor(IRepositories cache, INetworker networker) {
        this.cache = cache;
