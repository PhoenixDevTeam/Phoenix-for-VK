...
public abstract class CustomRequestException extends Exception {
    ...
    /**
     * Constructs a new {@link com.foxykeep.datadroid.exception.CustomRequestException} that includes the current stack trace.
     */
    ...
    /**
     * Constructs a new {@link com.foxykeep.datadroid.exception.CustomRequestException} that includes the current stack trace, the
    ...
    /**
     * Constructs a new {@link com.foxykeep.datadroid.exception.CustomRequestException} that includes the current stack trace and the
